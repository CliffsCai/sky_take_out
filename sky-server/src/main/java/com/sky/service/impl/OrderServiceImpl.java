...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderSubmitVO submitOrder(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        //向明细表插入n条数据
        orderDetailMapper.submitDetail(orderDetailList);
...
//        );
    ...
    public void cancelById(Long id) {
        Orders orders = Orders.builder().id(id).cancelTime(LocalDateTime.now()).status(Orders.CANCELLED).build();
    ...
    @Override
    public void adminCancelById(Orders orders) {
    ...
    public OrderStatisticsVO showStatistics() {
        ...
        Integer confirmedNumber = orderMapper.getStatusCount(Orders.CONFIRMED);
        Integer toBeConfirmedNumber = orderMapper.getStatusCount(Orders.TO_BE_CONFIRMED);
    ...
    public void deliveryOrder(Long id) {
        ...
        ordersDTO.setId(id);
        ordersDTO.setStatus(Orders.DELIVERY_IN_PROGRESS);
        orderMapper.updateOrderStatus(ordersDTO);
    }

    @Override
    public void confirmOrder(OrdersDTO ordersDTO) {
        ordersDTO.setStatus(Orders.CONFIRMED);
        orderMapper.updateOrderStatus(ordersDTO);
    }
    ...
    public void rejectionOrder(Orders orders) {
        ...
        orderMapper.rejectOrder(orders);
    }
    ...
    public void completeOrder(Long id) {
        OrdersDTO ordersDTO = new OrdersDTO();
        ordersDTO.setId(id);
        ordersDTO.setStatus(Orders.COMPLETED);
        orderMapper.updateOrderStatus(ordersDTO);
    }
